...
#ifndef PROJECT_ITERATION2_SRC_INCLUDE_BASE_GFX_APP_H_
#define PROJECT_ITERATION2_SRC_INCLUDE_BASE_GFX_APP_H_
...
#endif  /* PROJECT_ITERATION2_SRC_INCLUDE_BASE_GFX_APP_H_ */
