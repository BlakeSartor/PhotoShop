...
#ifndef PROJECT_ITERATION1_SRC_INCLUDE_BASE_GFX_APP_H_
#define PROJECT_ITERATION1_SRC_INCLUDE_BASE_GFX_APP_H_
...
#endif  // PROJECT_ITERATION1_SRC_INCLUDE_BASE_GFX_APP_H_
