...
#ifndef PROJECT_ITERATION1_SRC_INCLUDE_PIXEL_BUFFER_H_
#define PROJECT_ITERATION1_SRC_INCLUDE_PIXEL_BUFFER_H_
...
#endif  // PROJECT_ITERATION1_SRC_INCLUDE_PIXEL_BUFFER_H_"
