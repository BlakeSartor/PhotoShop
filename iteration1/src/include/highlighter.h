...
#ifndef PROJECT_ITERATION1_SRC_INCLUDE_HIGHLIGHTER_H_
#define PROJECT_ITERATION1_SRC_INCLUDE_HIGHLIGHTER_H_
...
#endif  // PROJECT_ITERATION1_SRC_INCLUDE_HIGHLIGHTER_H_
